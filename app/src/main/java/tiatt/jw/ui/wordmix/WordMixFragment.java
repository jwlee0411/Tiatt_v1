...
public class WordMixFragment extends Fragment {
    ...
    private WordMixViewModel wordMixViewModel;
    ...
    public void ReArrange()
    {
        ...
        for(int insertCur = 0; insertCur < 6 ; insertCur++)
        {
            numbers[insertCur] = (int)(Math.random() * QuestionNum);
        ...
        {
            wordSet[i] = ChangeArr[numbers[i/2]][0];
            wordSet[i+1] = ChangeArr[numbers[i/2]][1];
        }



        for(int insertCur = 0; insertCur < 12 ; insertCur++)
        {
            location[insertCur] = (int)(Math.random() * 12);

            for(int searchCur = 0; searchCur < insertCur; searchCur ++)
            {
                if(location[insertCur] == location[searchCur]){
                    insertCur--;
                    break;
                }
            }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
       ...
       wordMixViewModel = ViewModelProviders.of(this).get(WordMixViewModel.class);
    ...
    //numbers : 선정한 6개의 단어(이거는 의미X)
        //location : 12개 낱말의 정보(예 : location[0]이면 첫번째 칸의 단어
        ...
        buttons[i].setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (doubleClicked)
                {
                    ...
                    System.out.println(location[answerNum]);
    ...
    buttonShare.setOnClickListener(new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            String Test_Message = "'띠앗' 에서는 \n "+textAnswer.getText() + "와 같은 단어를 알아보는 우리말 놀이를 할 수 있어요!\n건전한 우리말 생활, '띠앗'과 함께 만들어가요!\nhttps://tinyurl.com/ti-att/";
    ...
    buttonReArrange.setOnClickListener(new View.OnClickListener() {
        @RequiresApi(api = Build.VERSION_CODES.JELLY_BEAN)
        @Override
        public void onClick(View view) {
            ReArrange();
